...
# Candidate Options
candidate_options = []
# Create an empty dictionary of candidate name and votes received
candidate_votes = {}
...
with open(file_to_load, encoding = "UTF-8") as election_data:
    ...
    for row in file_reader:
        ...
        # Print candidate name to the candidate list. 
...
# through the counts. 
# a) Iterate through the candidate list.
for candidate_name in candidate_votes:
    ...
    vote_percentage = float(votes) / float(total_votes) * 100
     ...
     # d) Print the candidate name and percentage votes.
...
# of votes to terminal.
    ...
    # a) Determine winning vote count and candidate
    # b) Determine if the votes is greater than the winning count. 
